...
char zft_src[] __initdata = "$Source: /home/cvsroot/RT2880-Linux/src/linux-2.4.30/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: #1 $";
char zft_dat[] __initdata = "$Date: 2014/05/07 $";
