 ...
 * $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/linux-2.4.x/drivers/mtd/ftl.c#1 $
 *
...
int init_ftl(void)
{
    ...
    DEBUG(0, "$Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/linux-2.4.x/drivers/mtd/ftl.c#1 $\n");
