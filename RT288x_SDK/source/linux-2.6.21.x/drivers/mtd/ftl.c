 ...
 * $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/linux-2.6.21.x/drivers/mtd/ftl.c#1 $
 *
...
{
	DEBUG(0, "$Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/linux-2.6.21.x/drivers/mtd/ftl.c#1 $\n");
