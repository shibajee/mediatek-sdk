/*
** $Id: //WIFI_SOC/MP/SDK_4_3_0_0/RT288x_SDK/source/linux-2.6.36MT.x/arch/mips/include/asm/tc3162/tc3162.h#1 $
*/
/************************************************************************
 *
...
/*
** $Log: tc3162.h,v $
** Revision 1.6  2012-04-19 08:08:28  michael
** fix isRT6855&6 macro
**
** Revision 1.5  2012-03-09 10:11:57  kurtis
** replace rt63365 keyword with rt6855A
**
** Revision 1.4  2012-03-05 08:53:37  michael
** for RT6856&RT6855 SLT program
**
...
#define isRT6856 	((((VPint(0xbfb0008c) >> 8) & 0x7) == 0x6)? 1 : 0)
#define isRT6855	((((VPint(0xbfb0008c) >> 8) & 0x7) == 0x4)? 1 : 0)
...
#define HS_IIR_INDICATOR				VPchar(CR_HSUART_IIR)
#define HS_IIR_RECEIVED_LINE_STATUS			0x06
#define HS_IIR_RECEIVED_DATA_AVAILABLE			0x04
#define HS_IIR_RECEIVER_IDLE_TRIGGER			0x0C
#define HS_IIR_TRANSMITTED_REGISTER_EMPTY		0x02
#define HS_LSR_INDICATOR				VPchar(CR_HSUART_LSR)
#define HS_LSR_RECEIVED_DATA_READY			0x01
#define HS_LSR_OVERRUN					0x02
#define HS_LSR_PARITY_ERROR				0x04
#define HS_LSR_FRAME_ERROR				0x08
#define HS_LSR_BREAK					0x10
#define HS_LSR_THRE					0x20
#define HS_LSR_THE					0x40
#define HS_LSR_RFIFO_FLAG				0x80

#define hsuartTxIntOn()		VPchar(CR_HSUART_IER) |= IER_THRE_INTERRUPT_ENABLE
#define hsuartTxIntOff()	VPchar(CR_HSUART_IER) &= ~IER_THRE_INTERRUPT_ENABLE
#define hsuartRxIntOn()		VPchar(CR_HSUART_IER) |= IER_RECEIVED_DATA_INTERRUPT_ENABLE
#define hsuartRxIntOff()	VPchar(CR_HSUART_IER) &= ~IER_RECEIVED_DATA_INTERRUPT_ENABLE
