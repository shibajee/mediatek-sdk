		...
		const struct data_string *server_id)
{
	...
	/*
	 * MTK/Ralink
	 * https://build.merproject.org/package/view_file?file=dhcp-4.2.0-UseMulticast.patch&package=dhclient&project=home%3Anotmart%3AMer_Extras&rev=1f67698e80c28ed6195aba91db786eb0
	 *
	 * for dhcp server 1-42(perhaps including 50,57,60)
	 */
