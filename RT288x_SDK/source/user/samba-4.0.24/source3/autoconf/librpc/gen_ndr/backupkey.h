...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB public_exponent;/* [subcontext(0),flag(LIBNDR_FLAG_REMAINING),subcontext_size(4)] */
	DATA_BLOB modulus;/* [subcontext(0),subcontext_size(256),flag(LIBNDR_FLAG_REMAINING)] */
	...
	DATA_BLOB coefficient;/* [subcontext(0),subcontext_size(128),flag(LIBNDR_FLAG_REMAINING)] */
