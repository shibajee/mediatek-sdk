...
struct tevent_req *dcerpc_spoolss_GetJob_send(TALLOC_CTX *mem_ctx,
					      ...
					      DATA_BLOB *_buffer /* [in] [unique] */,
					      uint32_t _offered /* [in]  */,
					      union spoolss_JobInfo *_info /* [out] [subcontext(4),subcontext_size(offered),unique,switch_is(level)] */,
					      uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinter_send(TALLOC_CTX *mem_ctx,
						  ...
						  DATA_BLOB *_buffer /* [in] [unique] */,
						  uint32_t _offered /* [in]  */,
						  union spoolss_PrinterInfo *_info /* [out] [switch_is(level),unique,subcontext(4),subcontext_size(offered)] */,
						  uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriver_send(TALLOC_CTX *mem_ctx,
							...
							DATA_BLOB *_buffer /* [in] [unique] */,
							uint32_t _offered /* [in]  */,
							union spoolss_DriverInfo *_info /* [out] [subcontext(4),subcontext_size(offered),unique,switch_is(level)] */,
							uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriverDirectory_send(TALLOC_CTX *mem_ctx,
								 ...
								 DATA_BLOB *_buffer /* [in] [unique] */,
								 uint32_t _offered /* [in]  */,
								 union spoolss_DriverDirectoryInfo *_info /* [out] [unique,switch_is(level),subcontext_size(offered),subcontext(4)] */,
								 uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrintProcessorDirectory_send(TALLOC_CTX *mem_ctx,
								  ...
								  DATA_BLOB *_buffer /* [in] [unique] */,
								  uint32_t _offered /* [in]  */,
								  union spoolss_PrintProcessorDirectoryInfo *_info /* [out] [subcontext_size(offered),subcontext(4),switch_is(level),unique] */,
								  uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetForm_send(TALLOC_CTX *mem_ctx,
					       ...
					       DATA_BLOB *_buffer /* [in] [unique] */,
					       uint32_t _offered /* [in]  */,
					       union spoolss_FormInfo *_info /* [out] [unique,switch_is(level),subcontext(4),subcontext_size(offered)] */,
					       uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriver2_send(TALLOC_CTX *mem_ctx,
							 ...
							 union spoolss_DriverInfo *_info /* [out] [unique,switch_is(level),subcontext_size(offered),subcontext(4)] */,
							 uint32_t *_needed /* [out] [ref] */,
...
struct tevent_req *dcerpc_spoolss_EnumPrinterKey_send(TALLOC_CTX *mem_ctx,
						      ...
						      union spoolss_KeyNames *_key_buffer /* [out] [switch_is(*_ndr_size),subcontext_size(*_ndr_size*2),ref,subcontext(0)] */,
						      uint32_t _offered /* [in]  */,
						      uint32_t *_needed /* [out] [ref] */);
