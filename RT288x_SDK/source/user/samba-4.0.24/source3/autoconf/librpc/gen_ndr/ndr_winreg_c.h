...
struct tevent_req *dcerpc_winreg_EnumValue_send(TALLOC_CTX *mem_ctx,
						...
						uint8_t *_value /* [in,out] [length_is(length?*length:0),size_is(size?*size:0),range(0,0x4000000),unique] */,
...
struct tevent_req *dcerpc_winreg_QueryValue_send(TALLOC_CTX *mem_ctx,
						 ...
						 enum winreg_Type *_type /* [in,out] [unique] */,
						 uint8_t *_data /* [in,out] [size_is(data_size?*data_size:0),length_is(data_length?*data_length:0),unique,range(0,0x4000000)] */,
...
struct tevent_req *dcerpc_winreg_QueryMultipleValues_send(TALLOC_CTX *mem_ctx,
							  ...
							  uint8_t *_buffer /* [in,out] [size_is(*buffer_size),length_is(*buffer_size),unique] */,
