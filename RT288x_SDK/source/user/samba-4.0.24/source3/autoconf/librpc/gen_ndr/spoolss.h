...
}/* [flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,relative_base,gensize,nodiscriminant] */;
...
}/* [nodiscriminant,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),gensize,relative_base] */;
...
}/* [nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),public,gensize,relative_base] */;
...
}/* [public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base,gensize,nodiscriminant] */;
...
struct spoolss_PrinterEnumValues {
	...
	DATA_BLOB *data;/* [subcontext(0),subcontext_size(data_length),flag(LIBNDR_FLAG_REMAINING|ndr_spoolss_PrinterEnumValues_align(r->type)),relative] */
...
struct spoolss_GetJob {
	...
	struct {
		union spoolss_JobInfo *info;/* [subcontext(4),subcontext_size(offered),unique,switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinter {
	...
	struct {
		union spoolss_PrinterInfo *info;/* [switch_is(level),unique,subcontext(4),subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver {
	...
	struct {
		union spoolss_DriverInfo *info;/* [subcontext(4),subcontext_size(offered),unique,switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	...
	struct {
		union spoolss_DriverDirectoryInfo *info;/* [unique,switch_is(level),subcontext_size(offered),subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrintProcessorDirectory {
	...
	struct {
		union spoolss_PrintProcessorDirectoryInfo *info;/* [subcontext_size(offered),subcontext(4),switch_is(level),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetForm {
	...
	struct {
		union spoolss_FormInfo *info;/* [unique,switch_is(level),subcontext(4),subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver2 {
	...
	struct {
		union spoolss_DriverInfo *info;/* [unique,switch_is(level),subcontext_size(offered),subcontext(4)] */
		uint32_t *needed;/* [ref] */
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [switch_is(*_ndr_size),subcontext_size(*_ndr_size*2),ref,subcontext(0)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
